...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Bookshop'); ?></title>
...
<header class="header">
    <div class="header__inner container">
        ...
        <a href="<?php echo e(route('catalog.index')); ?>" class="logo text-decoration-none">
            <span class="logo__book">Book</span><span class="logo__shop">store</span>
        </a>

        <nav class="nav" aria-label="Main navigation">
            <a href="<?php echo e(route('catalog.index')); ?>"
               class="nav__link <?php echo e(request()->routeIs('catalog.index') ? 'nav__link--active' : ''); ?>">
                CATALOG
            </a>
...
<footer class="footer">
    <div class="footer__inner container">
        <div>
            <a href="<?php echo e(route('catalog.index')); ?>" class="footer__logo logo text-decoration-none">
                <span class="logo__book">Book</span><span class="logo__shop">store</span>
            </a>
        ...
        <div>
            ...
            <ul class="footer__links">
                <li><a href="<?php echo e(route('catalog.index')); ?>">Catalog</a></li>
    ...
    <div class="footer__bottom">
        © <?php echo e(date('Y')); ?> Bookstore. All rights reserved.
    </div>
</footer>
